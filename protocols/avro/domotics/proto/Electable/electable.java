...
public interface electable {
  ...
  int ConnectThermostat(int SensorID, java.lang.CharSequence IP) throws org.apache.avro.AvroRemoteException;
  ...
  java.lang.Void UpdateTemperature(double temperature) throws org.apache.avro.AvroRemoteException;
  double GetTemperature() throws org.apache.avro.AvroRemoteException;
  java.util.List<java.lang.Double> GetTemperatureHistory() throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends electable {
    ...
    void ConnectThermostat(int SensorID, java.lang.CharSequence IP, org.apache.avro.ipc.Callback<java.lang.Integer> callback) throws java.io.IOException;
    ...
    void UpdateTemperature(double temperature, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
